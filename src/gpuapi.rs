...
// cards are not shared among processes.  Furthermore, if the size of `devices` is larger than 1
// then the values reported here should be divided among those devices, either evenly or (with
// CardState information in mind) in some kind of proportional manner.

#[derive(PartialEq, Default, Clone, Debug)]
pub struct Process {
    pub devices: Vec<GpuName>,
