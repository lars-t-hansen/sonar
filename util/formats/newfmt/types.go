...
// constant) following.  The special +preamble comment is emitted as a preamble.
//
// NOTE: The "///" comment above a type or const must be separated by that type or const by a blank
// line, or `go fmt` will turn "///" into "// /".
...
const ExtendedUintUnset ExtendedUint = 0

/// The infinite value

const ExtendedUintInfinite ExtendedUint = 1

/// The base value for finite, set values

const ExtendedUintBase ExtendedUint = 2
...
const DataTagSample DataType = "sample"

/// The tag for "sysinfo" records

const DataTagSysinfo DataType = "sysinfo"

/// The tag for "job" records

const DataTagJobs DataType = "job"

/// The tag for "cluster" records

const DataTagCluster DataType = "cluster"
